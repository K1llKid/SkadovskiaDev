local function ixActMenu()
	...
	for i = 1, 14 do
		...
		Perso:DockMargin( 8, 0, 0, 0 )
		Perso:SetFont("ixSmallFont")
		Perso:SetText( "Roubles : ".. ix.currency.Get(LocalPlayer():GetCharacter():GetMoney()) )
		Perso:SetSize( 36, 20 )
		left:AddItem( Perso )
		...
		Perso:DockMargin( 8, 0, 0, 0 )
		Perso:SetFont("ixSmallFont")
		Perso:SetText( "Vie : ".. LocalPlayer():Health() )
		Perso:SetSize( 36, 20 )
		left:AddItem( Perso )
		...
		Perso:DockMargin( 8, 0, 0, 0 )
		Perso:SetFont("ixSmallFont")
		Perso:SetText( "Armure : ".. LocalPlayer():Armor() )
		Perso:SetSize( 36, 20 )
		left:AddItem( Perso )
		...
		Perso:DockMargin( 8, 0, 0, 0 )
		Perso:SetFont("ixSmallFont")
		Perso:SetText( "Réputation : ".. LocalPlayer():Armor() )
		Perso:SetSize( 36, 20 )
		left:AddItem( Perso )
